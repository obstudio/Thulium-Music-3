module.exports = {
  name: 'TmLoading',
  template: `<div class="" style="width: 100%; height: 100%; background-color: #2d2d2d; z-index: 33; display: flex; align-items: center; justify-content: center; flex-direction: column">
